...
public partial class SakilaContext : DbContext
{
    ...
    public virtual DbSet<CustomersSpendingMoreThanHundred> CustomersSpendingMoreThanHundreds { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=sakila;Trusted_Connection=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Actor>(entity =>
        {
            entity.HasKey(e => e.ActorId).HasName("PK__actor__8B2447B4801449F8");
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__address__CAA247C8605A8CE1");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__category__D54EE9B4F1A1FBDC");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8885109A9");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD05580FB46CD");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85D3FDB616");
        ...
        modelBuilder.Entity<CustomersSpendingMoreThanHundred>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("customersSpendingMoreThanHundred");

            entity.Property(e => e.AntalBetalningar).HasColumnName("antalBetalningar");
            entity.Property(e => e.Betalt)
                .HasColumnType("decimal(38, 2)")
                .HasColumnName("betalt");
            entity.Property(e => e.Email)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("email");
            ...
            entity.Property(e => e.LastName)
                ...
                .IsUnicode(false)
                .HasColumnName("last_name");
            entity.Property(e => e.MaxBetalning)
                .HasColumnType("decimal(5, 2)")
                .HasColumnName("maxBetalning");
            entity.Property(e => e.MedelBetalning)
                .HasColumnType("decimal(38, 6)")
                .HasColumnName("medelBetalning");
            entity.Property(e => e.MinBetalning)
                .HasColumnType("decimal(5, 2)")
                .HasColumnName("minBetalning");
            entity.Property(e => e.UnikaKunder).HasColumnName("unikaKunder");
        });

        modelBuilder.Entity<Film>(entity =>
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film__349764A9AC280691");
        ...
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId }).HasName("PK__film_act__086D31FE3C5057CE");
        ...
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId }).HasName("PK__film_cat__69C38A3242A1C397");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film_tex__349764A954AE3962");
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC49441497E4");
        ...
        {
            entity.HasKey(e => e.LanguageId).HasName("PK__language__804CF6B38208F469");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EAD3975A85");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__rental__67DB611B37E978BC");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staff__1963DD9CB76681DB");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__store__A2F2A30C4D2A7603");
